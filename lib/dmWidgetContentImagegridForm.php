...
class dmWidgetContentImagegridForm extends dmWidgetPluginForm
{
  protected static
  $methods = array(
    'center' => 'Center',
  ...
  {
    return $this->getHelper()->renderPartial('dmWidgetImagegrid', 'form', array(
      'form' => $this,
      'medias' => $this->getMedias(),
      'baseTabId' => 'dm_widget_imagegrid_'.$this->dmWidget->get('id')
    ));
  }
